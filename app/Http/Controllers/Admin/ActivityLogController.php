...
class ActivityLogController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $actions = [
            ...
            AdminActivityLog::ACTION_PARODY_CREATED => 'Parody created',
            AdminActivityLog::ACTION_PARODY_UPDATED => 'Parody updated',
            AdminActivityLog::ACTION_PARODY_DELETED => 'Parody deleted',
            ...
            AdminActivityLog::ACTION_CONTACT_MESSAGE_REPLIED => 'Contact message replied',
        ];
